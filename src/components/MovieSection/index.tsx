...
const movies: Movie[] = [
  {
    id: 1,
    src: "public/Imagens/Cards filmes/Card - Amigo da sombra.png",
  ...
  {
    id: 3,
    src: "public/Imagens/Cards filmes/Card - Amigos do bosque mágico.png",
  ...
  {
    id: 4,
    src: "public/Imagens/Cards filmes/Card - Caminho para o abismo.png",
  ...
  {
    id: 5,
    src: "public/Imagens/Cards filmes/Card - Desastres do Escritório.png",
  ...
  {
    id: 6,
    src: "public/Imagens/Cards filmes/Card - Mestres do futuro.png",
  ...
  {
    id: 7,
    src: "public/Imagens/Cards filmes/Card - La Esperanza.png",
  ...
  {
    id: 8,
    src: "public/Imagens/Cards filmes/Card - O nexus do tempo.png",
